...
describe('instantiate client', () => {
  ...
  describe('logging', () => {
    ...
    test('default logLevel is warn', async () => {
      const client = new Compeer({ bearerToken: 'My Bearer Token' });
    ...
    test('debug logs happen with debug env var', async () => {
      ...
      const client = new Compeer({ logger: logger, bearerToken: 'My Bearer Token' });
  ...
  describe('baseUrl', () => {
    ...
    test('explicit option', () => {
      const client = new Compeer({ baseURL: 'https://example.com', bearerToken: 'My Bearer Token' });
    ...
    test('in request options overridden by client options', () => {
      const client = new Compeer({ bearerToken: 'My Bearer Token', baseURL: 'http://localhost:5000/client' });
      expect(client.buildURL('/foo', null, 'http://localhost:5000/option')).toEqual(
  ...
  test('maxRetries option is correctly set', () => {
    const client = new Compeer({ maxRetries: 4, bearerToken: 'My Bearer Token' });
    expect(client.maxRetries).toEqual(4);

    // default
    const client2 = new Compeer({ bearerToken: 'My Bearer Token' });
...
describe('retries', () => {
  ...
  test('retry on 429 with retry-after', async () => {
    ...
    const client = new Compeer({ bearerToken: 'My Bearer Token', fetch: testFetch });
